...
var ajaxChat = {
	...
	getChatListMessageString: function(dateObject, userID, userName, userRole, messageID, messageText, channelID, ip) {
		...
		return	'<div id="'
				...
				+ ' dir="'
				+ this.baseDirection
				+ '" onclick="ajaxChat.insertText(\'[b]&#64;[i]\'+this.firstChild.nodeValue+\'[/i] &#187; [/b]\');">'
				+ userName
				+ '</span>'
				+ colon
	...
	deleteCookies: function() {
		...
		this.createCookie(this.sessionName,'', -1);
		this.createCookie(this.sessionName + '_lang','', -1);
		this.createCookie(this.sessionName + '_settings', '', -1);
		this.createCookie(this.sessionName + '_style','',-1);
	},
